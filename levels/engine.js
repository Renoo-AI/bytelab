...
(function() {
    ...
    const ROOM_DATA = {
        en: {
            ...
            w2l1:{title:"Cookie Tier Escalation",desc:"Netflix limits streams based on the tier cookie. Free users can't access premium content.",objective:"Change the tier cookie from 'free' to 'premium' to upgrade your streaming access."},
            ...
            w4l1:{title:"SSO User ID Spoof",desc:"SpaceX identifies users via a cookie. Change the user_id to impersonate an admin.",objective:"Change the user_id cookie to '1' to impersonate the root administrator."},
            ...
            w6l1:{title:"Telemetry Data Spoof",desc:"SpaceX's satellite telemetry can be edited client-side. Fake the altitude readings.",objective:"Type 'altitude:9999' in the telemetry input to spoof the satellite altitude."},
        ...
        ar: {
            ...
            w2l1:{title:"تصعيد صلاحية الكوكيز",desc:"Netflix يحدد جودة البث بناءً على الكوكيز. غيّرها للحصول على بريميوم.",objective:"غيّر tier cookie من free إلى premium لترقية صلاحية البث."},
            ...
            w4l1:{title:"انتحال معرف المستخدم",desc:"SpaceX يتعرف على المستخدمين عبر cookie. غيّره لانتحال حساب أدمن.",objective:"غيّر user_id cookie إلى '1' لانتحال صلاحية المشرف."},
