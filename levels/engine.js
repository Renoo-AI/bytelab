...
(function() {
    ...
    const ROOM_DATA = {
        en: {
            ...
            w2l1:{title:"Cookie Tier Escalation",desc:"NNetflix limits streams based on the tier cookie. Free users can't access premium content.",objective:"Change the tier cookie from 'free' to 'premium' to upgrade your streaming access."},
        ...
        ar: {
            ...
            w2l1:{title:"تصعيد صلاحية الكوكيز",desc:"NNetflix يحدد جودة البث بناءً على الكوكيز. غيّرها للحصول على بريميوم.",objective:"غيّر tier cookie من free إلى premium لترقية صلاحية البث."},
